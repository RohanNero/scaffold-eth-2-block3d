 ...
 *  THESE ARE ONLY FOR EXAMPLE AND WILL BLOCK ANYONE:
 *  1. Not listed in the "Original Gangsters" `addresses` array
 *  2. Not holding 1 USDC ON EITHER MAINNET, ARBITRUM, OR POLYGON
 */
      ...
      contracts: [
        {
          ...
          minimumBal: "1000000", // minimum amount of tokens an address must hold
        },
        {
